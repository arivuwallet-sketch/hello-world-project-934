...
const NAV = [
  ...
  { to: "/connection", label: "Connection Wizard", icon: PlugZap },
  { to: "/adapter", label: "Adapter Health", icon: Radio },
  { to: "/full-scan", label: "Full Vehicle Scan", icon: Radar },
  { to: "/topology", label: "ECU Topology", icon: Network },
  { to: "/graphs", label: "Waveforms", icon: LineChart },
  { to: "/evidence-recorder", label: "Evidence Recorder", icon: CircleDot },
  { to: "/dtc-analysis", label: "DTC Analysis", icon: Microscope },
  { to: "/guided-diagnostics", label: "Guided Diagnostics", icon: GitBranch },
  { to: "/service-functions", label: "Service Functions", icon: Wrench },
  { to: "/local-agent", label: "Local Agent", icon: Radio },
  { to: "/diagnostic-tests", label: "Diagnostic Tests", icon: FlaskConical },
  ...
  { to: "/safety", label: "Safety Systems", icon: ShieldCheck },
  { to: "/security", label: "Security", icon: Lock },
  { to: "/ev", label: "EV Diagnostics", icon: BatteryCharging },
  { to: "/tuning", label: "ECU Tuning", icon: SlidersHorizontal },
  { to: "/performance", label: "Performance", icon: Timer },
  { to: "/health", label: "Health & Events", icon: HeartPulse },
  { to: "/reports", label: "Reports", icon: FileText },
  { to: "/service", label: "Service History", icon: ClipboardList },
